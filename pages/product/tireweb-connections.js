...
export default function Page() {
  ...
  return (
    <Layout
      title="Tireweb Connections: Integrations and APIs for the Tire Industry"
      description="Facilitate effortless integrations between manufacturers, wholesalers, and retailers with Tireweb Connections. Optimize your tire business connectivity today."
      canonical="https://www.tireweb.com/product/tireweb-connections"
    >
        ...
        <div className="container">
          ...
          <div data-w-id="28b40e73-0df3-1c50-a379-8e05017605c9" className="key-wraper navy-blue-section-wraper">
            ...
            <div className="key-box connection-box">
              ...
              <p className="pargraph-medium">Data is mapped to a unique Manufacturer Product Code to allow seamless integration with multiple systems and distributors at once.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="seamless-wraper">
            <div className="section-heading canter-heading">
              <h2 className="heading-two">Seamless Integration with Point of Sale Systems</h2>
              <div className="_10px-gap"></div>
              <div className="border-line">
                <div className="border-line-icons auto-line"></div>
              </div>
              <div className="_10px-gap"></div>
              <p className="pargraph-medium">Many Point of Sale (POS) systems have direct integrations with Tireweb Connections, allowing tire dealers to purchase inventory from multiple tire wholesalers without leaving the POS system.</p>
              <div className="_30px-gap"></div>
            </div>
          </div>
        </div>
      ...
      <section className="section-benefits navy-blue-background bottom-gap">
        <div className="container">
          <div className="section-heading canter-heading">
            <h2 className="heading-two">Key Features &amp; Benefits of Tireweb Connections</h2>
            <div className="_10px-gap"></div>
            <div className="border-line">
              <div className="border-line-icons auto-line"></div>
            </div>
          ...
          <div data-w-id="40b3285f-18fe-d9db-36e8-8b8768b29ecf" className="benifits-wraper">
            <div className="benifits-wraper-box _50-width white-box">
              <h3 className="heading-three">Varied Data Support</h3>
              <div className="border-line">
                <div className="border-line-icons"></div>
              </div>
              ...
              <p className="pargraph-medium">We provide API calls, Remote Data flat files for inventory and pricing and our Tirelibrary product catalog with images.</p>
            </div>
            <div className="benifits-wraper-box _50-width white-box">
              <h3 className="heading-three">Unified Connectivity</h3>
              <div className="border-line">
                <div className="border-line-icons"></div>
              </div>
              <div className="number-box">
              ...
              <p className="pargraph-medium">Seamlessly integrate with major POS and ERP systems and tire distributors, simplifying data retrieval and updates.</p>
            </div>
            <div className="benifits-wraper-box _50-width white-box">
              <h3 className="heading-three">Live Data Handling</h3>
              <div className="border-line">
                <div className="border-line-icons"></div>
              </div>
              <div className="number-box">
              ...
              <p className="pargraph-medium">Ensure businesses remain updated with real-time inventory status, dynamic pricing, and quick order management.</p>
            </div>
            <div className="benifits-wraper-box _50-width white-box">
              <h3 className="heading-three">Developer-centric Resources</h3>
              <div className="border-line">
                <div className="border-line-icons"></div>
              </div>
              <div className="number-box">
              ...
              <p className="pargraph-medium">Our extensive documentation and 24/7 support team ensure you&#x27;re never in the dark, facilitating hassle-free integration and troubleshooting.</p>
            </div>
          </div>
          <div className="_30px-gap"></div>
        </div>
