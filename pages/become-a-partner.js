          ...
          <div className="conatct-wraper">
            <div className="contact-form">
              ...
              <div className="w-form">
                <form id="wf-form-Become-Partner-Contact-form" onSubmit={handleSubmit} name="wf-form-Become-Partner-Contact-form" data-name="Become Partner-Contact form" className="extra-padding-bottom">
